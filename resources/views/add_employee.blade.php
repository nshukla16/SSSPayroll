  ...
  <div class="container">
    ...
    <div class="col-md-12">
          <div class="row">
            ...
            <input type="text" class="form-control" placeholder="Enter Employee Code" name="emp_code" id="emp_code" value="{{'SSS_'.$emp}}" readonly>   
        ...
        <div class="row">
            ...
            <input type="text" class="form-control" placeholder="Enter Employee Name" name="emp_name" id="emp_name" required>                
            </div>
        </div>
         <div class="row">
            <div class="col-md-12">
            <label for="joinin_dt"><b>Joining Date</b></label>
            <input type="date" class="form-control" name="joining_dt" max="{{date('Y-m-d')}}" onkeypress="return false;" required>                
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
...
<!-- </form> -->
        ...
        <div class="row">
            ...
            <input type="email" class="form-control" placeholder="Enter Email" name="email_p" id="email">                
            </div>
        </div>
         <div class="row">
            <div class="col-md-12">
            <label for="email"><b>Username</b></label>
            <input type="text" class="form-control" placeholder="Enter Email" name="username" id="email" >                
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
            <label for="pwd"><b>Password</b></label>
            <input type="text" class="form-control" placeholder="Enter Password" name="pwd" id="pwd" >                
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
            <label for="tel"><b>Phone Number</b></label>
            <input type="number" onkeydown="javascript: return event.keyCode === 8 ||event.keyCode === 46 ? true : !isNaN(Number(event.key))"  class="form-control" placeholder="Enter Phone Number" name="ph_number" id="ph_number" >
            </div>
        </div>
         <div class="row">
            <div class="col-md-12">
            <label for="pan_no"><b>PAN NO</b></label>
            <input type="text" class="form-control" placeholder="Enter PAN No" name="pan_no" maxlength="10" minlength="10">
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
            <label for="aadhar_no"><b>AADHAR NO</b></label>
            <input type="text" class="form-control" placeholder="Enter AADHAR No" name="aadhar_no" maxlength="12" minlength="12">
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
            <label for="address"><b>Current Address</b></label>
            <textarea type="text" class="form-control" placeholder="Enter Current Address" name="current_add" id="current_add" rows="2"></textarea>
            </div>
        </div> 
        <div class="row">
            <div class="col-md-12">
        ...
        <div class="row">
            ...
            <textarea type="text" class="form-control" placeholder="Enter Permanent Address" name="permanent_add" id="permanent_add" rows="2"></textarea>
            </div>
        </div>
...
<script type="text/javascript">
    function add_desg() {
        var name=document.getElementById('desg').value;
        // alert(name);
        $.ajax({
            type:'POST',
            url:'/add_desg1',
