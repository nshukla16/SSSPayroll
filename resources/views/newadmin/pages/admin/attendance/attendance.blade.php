...
@section('content')
    <!-- Page Wrapper -->
			...
			<div class="col-auto float-right ml-auto content-print">
				...
				<div class="col-sm-6 col-md-3">  
					...
					<div class="col-sm-6 col-md-3">  
						<div class="form-group form-focus">
							...
							<option value='{{$value->id}}' @if(request()->dept==$value->id) selected="selected" @endif>{{$value->name}} ( {{$value->b_name}} )</option>
																	...
																	<div class="card-body">
																		...
																		<div class="punch-info">
																			<div class="punch-hours">
																				...
																				@endphp	
																				{{(sizeof($resp_in[0])>0 && sizeof($resp_out[0])>0)?(floor($diff / 60).':'.($diff -   floor($diff / 60) * 60).' hrs'):'NA'}} 
																				</span>
																			</div>
																		</div>
																		<div class="punch-det">
...
<script type="text/javascript">
	function filter_data() {
		...
		// 		if(data.status==true)
		// 		{
				window.location.href='http://34.72.9.224/SSSPayroll/attendance_f/'+bid+'/'+mon_yr+'/'+dept+'/'+desg;
				// }else{
