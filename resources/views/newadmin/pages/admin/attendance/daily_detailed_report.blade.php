...
@section('content')
    <!-- Page Wrapper -->
                <div class="content container-fluid">
					...
					<div class="page-header not">
						<div class="row align-items-center">
							<div class="col">
				<h3 class="page-title">Daily Detailed Attendance Report</h3>
				<ul class="breadcrumb">
		...
		<!-- 	<div class="col-auto float-right ml-auto">
			...
			<h2 style="text-align: center;">SSS SyberTech PVT LTD</h2>
			<h3 style="text-align: center;">Daily Detailed Attendance Report</h3>
			...
			<h3 style="text-align: right;" id="currentTime">Generated On: <?php echo  date("d/m/Y");?></h3>
                   ...
                   <div class="printing" style="border-top:1px solid black;">
                    <div class="row filter-row" style="padding-top: 16px;">
						...
						<div class="col-sm-6 col-md-6">  
							<div class="form-group form-focus">
								<h4>Attendance Date: 03-Apr-2021 </h4>
	...
	function filter_data() {
		...
		// 		if(data.status==true)
		// 		{
				window.location.href='http://34.72.9.224/SSSPayroll/daily-detailed-report_f/'+bid+'/'+mon_yr+'/'+dept+'/'+desg;
				// }else{
    ...
    // Download it
    var filename = 'daily_detailed_report' + '.csv';
