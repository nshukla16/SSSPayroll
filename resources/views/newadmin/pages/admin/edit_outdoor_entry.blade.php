...
<div class="content container-fluid">
    ...
    <div class="page-header">
        <div class="row">
            <div class="col-sm-12">
                <h3 class="page-title">Edit Outdoor Manual Entry</h3>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                    <li class="breadcrumb-item active">Edit Outdoor Manual Entry</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Edit Outdoor Manual Entry</h4>
                  <!--   <ul class="nav nav-tabs nav-tabs-solid nav-tabs-rounded nav-justified"
                    ...
                    <form id="regForm" action="{{url('outdoor-manual-entry')}}" method="POST"
                        style="border: 1px solid lightgrey;box-shadow: 1px 1px 6px #e3e1e1;">
                        
                        <div class="tab-content">

                            <div class="tab-pane show active" id="solid-rounded-justified-tab1" style="margin: 10px;">
                                <h1 class="mb-4">Edit Outdoor Manual Entry</h1>
                                    <div class="row">
                                    <div class="col-lg-6">
