...
<div class="content container-fluid">
    <div class="row">
        ...
        <div class="row align-items-center">
            <div class="col">
                <h3 class="page-title">Company Group</h3>
                <ul class="breadcrumb">
   ...
   <div class="col-auto float-right ml-auto">
       <button form="companyGroup" class="btn btn-info map w-100" style="margin-left: 19px;" type="submit">Save</button>
    </div>
    </div>
            <form id="companyGroup" enctype="multipart/form-data" method="post">
            @csrf
            <div class="row">
                    ...
                    <div class="col-sm-4">
                    <div class="form-group">
                    <input class="form-control" type="text" required="required" placeholder="Enter company group Name">
                    </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                    <div class="form-group">
                    <input class="form-control" type="text" disabled="disable" placeholder="same as company group by default">
                    </div>
                    </div>
                    <div class="col-sm-2" id="labelCol1" style="text-align:center;">
                    <div class="form-group">
