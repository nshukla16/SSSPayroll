...
<div class="content container-fluid">
	...
	<div class="page-header">
		<div class="row align-items-center">
			<div class="col">
				<h3 class="page-title">Leaves Listing</h3>
				<ul class="breadcrumb">
					<li class="breadcrumb-item"><a href="{{url('home')}}">Dashboard</a></li>
					<li class="breadcrumb-item active">Leaves Listing</li>
				</ul>
			</div>
			<div class="col-auto float-right ml-auto">
				<a href="{{url('apply-leave')}}" class="btn add-btn"><i class="fa fa-plus"></i> Add Leaves</a>
						...
						<tbody id="myTable">
							<tr>
								...
								<td style="text-align: center;">
									<a href="{{url('edit-leave')}}" class="action-icon"><i class="fa fa-pencil"></i></a>
								</td>
							</tr>
